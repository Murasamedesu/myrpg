...
-- --------------------------------------------------
-- Date Created: 08/20/2026 19:44:08
-- Generated from EDMX file: F:\var\mmorpg\myrpg\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [ExtremeWorldMMORPG];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_GuildGuildMember]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GuildMembers] DROP CONSTRAINT [FK_GuildGuildMember];
GO
...
-- Creating foreign key on [TCharacterBag_Id] in table 'Characters'
ALTER TABLE [dbo].[Characters]
ADD CONSTRAINT [FK_CharacterBag]
    FOREIGN KEY ([TCharacterBag_Id])
...
ALTER TABLE [dbo].[GuildMembers]
ADD CONSTRAINT [FK_GuildGuildMember]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_GuildGuildMember'
CREATE INDEX [IX_FK_GuildGuildMember]
ON [dbo].[GuildMembers]
    ([TGuildId]);
GO
